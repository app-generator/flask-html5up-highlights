...
def register():
    ...
    page_title       = 'Register - Pixelarity design coded in Flask | AppSeed App Generator'
    page_description = 'HTML5 Up Pixelarity design coded in Flask Microframework, registration page.'
...
def login():
    ...
    page_title       = 'Login - Pixelarity design coded in Flask | AppSeed App Generator'
    page_description = 'HTML5 Up Pixelarity design coded in Flask Microframework, login page.'
